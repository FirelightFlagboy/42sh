...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/02/28 12:58:31 by anonymous          #+#    #+#             */
/*   Updated: 2018/05/09 11:29:20 by fbenneto         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** Pour ton t_bool regarde int x:1
*/
typedef char		t_bool;
...
void				ft_str2del(char ***ts);
size_t				ft_str2len(char **ts);
